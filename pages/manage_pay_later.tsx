...
import { Button, Box, Center, Image, Text, Group, Stack } from '@mantine/core'
    ...
    <Center w="100%" h="100%">
      <Box pos="relative" w={1400} h={800} sx={{ flexShrink: 0 }}>
        <Image
          ...
          width="100%"
          height="100%"
          src="/images/alibaba_manage_net_terms.png"
          alt="Alibaba Manage Net Terms"
        />
        <Box pos="relative" w="100%" h="100%">
          <Button
            ...
            w={60}
            h={54}
            sx={{ opacity: 0, ':hover': { opacity: 0.2 } }}
          ...
          <Button
            ...
            h={67}
            sx={{ opacity: 0, ':hover': { opacity: 0.2 } }}
            onClick={handleClickPayLaterSignup}
          />
          <Button
            pos="absolute"
            right={236}
            ...
            w={70}
            h={60}
            sx={{ opacity: 0.1, ':hover': { opacity: 0.1 } }}
