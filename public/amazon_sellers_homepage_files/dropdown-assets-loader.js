...
var ue_id = 'ABPPNKHERF2539EJGPPZ',
    ue_url = '/ap/uedata',
    ue_navtiming = 1,
    ue_mid = 'ATVPDKIKX0DER',
    ue_sid = '137-9116637-5138647',
    ...
    ue_rpl_ns = 'cel-rpl',
    ue_ddq = 1,
    ue_fpf = '//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:137-9116637-5138647:ABPPNKHERF2539EJGPPZ$uedata=s:',
    ue_sbuimp = 1,
    ue_ibft = 0,
    ue_sswmts = 0,
    ue_jsmtf = 0,
...
<!-- 3ayz3iuyutabot80idxps975xdunhfea77q2 -->
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 10185)</script><script>var aPageStart = (new Date()).getTime();</script><meta charset="utf-8"/>
    ...
    <script>
      if (!window.ueLogError) {
        ...
        <link rel="stylesheet" href="https://images-na.ssl-images-amazon.com/images/I/11EIQ5IGqaL._RC|01ZTHTZObnL.css,519YvOBDG8L.css,31uBZQYbDJL.css,012SlIQp3XL.css,11D3BPoiHRL.css,01qPl4hxayL.css,01pOTCa2wPL.css,413Vvv3GONL.css,11TIuySqr6L.css,01Rw4F+QU6L.css,11JJsNcqOIL.css,01J3raiFJrL.css,01IdKcBuAdL.css,01dRHIoUjnL.css,21lFcV0hmCL.css,01Sv7-fQIGL.css,51A6teW0QCL.css,01XPHJk60-L.css,11wvSzGn6tL.css,01ANX9Vx1mL.css,01cvE3JoRWL.css,21qiQ1rOUAL.css,01oATFSeEjL.css,21RWaJb6t+L.css,11yLJpkAxFL.css,21lGqyrfUAL.css,01CFUgsA-YL.css,31xzg1RDx1L.css,116t+WD27UL.css,111bsezNMhL.css,113QjYEJj-L.css,11BdrZWOJpL.css,01r-hR9jMmL.css,01X+Gu6WK9L.css,212+4QFg5TL.css,11SnKfMS3qL.css,01LzHhtXxxL.css,21zi3R-XjNL.css,115pt6oW+ZL.css,11hvENnYNUL.css,11Qek6G6pNL.css,01890+Vwk8L.css,014VAMpg+ZL.css,01qiwJ7qDfL.css,21TAMzcrOKL.css,01tkNT3LUNL.css,01WslS8q5ML.css,21qx+RW81IL.css,013-xYw+SRL.css_.css?AUIClients/AmazonUI&pNNUmGKB#us.not-trident.991784-T1.1073803-T2.1073045-T2.1074116-T2.1074121-T2.1073049-T2.1074849-T2" />
<link rel="stylesheet" href="https://images-na.ssl-images-amazon.com/images/I/01SdjaY0ZsL._RC|31jdWD+JB+L.css,51oKy2hIPYL.css_.css?AUIClients/AuthenticationPortalAssets" />
...
f){f||(f=c,c=D);var e=this.attribution;return function(){h.push(b||{attribution:e,name:c,logLevel:a});var d=f.apply(this,arguments);h.pop();return d}}}function B(a,b){this.load={js:R(this,!0),css:R(this)};y(this,"namespace",b);y(this,"attribution",a)}function V(){l.body?k.trigger("a-bodyBegin"):setTimeout(V,20)}"use strict";var t=C.now=C.now||function(){return+new C},r=function(a){return a&&a.now?a.now.bind(a):t}(g.performance),ia=r(),ha={},n=g.ue;E();E("aui_build_date:3.24.10-2025-01-09");var W=
...
l.addEventListener("DOMContentLoaded",aa=function(){k.trigger("a-domready");l.removeEventListener("DOMContentLoaded",aa,!1)},!1)}var ba=l.documentElement,la=g._pd(k,F,u,O,ba,W,P,m,"3.24.10-2025-01-09");F(/UCBrowser/i)||la.localStorage&&O(ba,W.getItem("a-font-class"));k.declare("a-event-revised-handling",!1);g._sw(N,p,F,X,m,n,E,G,u,k);k.declare("a-fix-event-off",!1);m("pagejs:pkgExecTime",r()-ia)})(window,document,Date);
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/11zuylp74DL._RC|61xJcNKKLXL.js,11Y+5x+kkTL.js,51F3LXOLEtL.js,11EeeaacI2L.js,11GgN1+C7hL.js,01+z+uIeJ-L.js,01VRMV3FBdL.js,21u+kGQyRqL.js,012FVc3131L.js,11aD5q6kNBL.js,11rRjDLdAVL.js,51zH7YD-TsL.js,11nAhXzgUmL.js,119kvzYmMJL.js,1110g-SvlBL.js,11npBNHo-jL.js,21eKR4hvwNL.js,0190vxtlzcL.js,51xvEQZx5oL.js,01JYHc2oIlL.js,31nfKXylf6L.js,01ktRCtOqKL.js,01ASnt2lbqL.js,11bEz2VIYrL.js,31o2NGTXThL.js,01rpauTep4L.js,21GvGVQVlqL.js,01tvglXfQOL.js,11+FwJUUPNL.js,01xL7X47osL.js_.js?AUIClients/AmazonUI&C6vO4CWS#372963-T1');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/21ZMwVh4T0L._RC|21OJDARBhQL.js,218GJg15I8L.js,31lucpmF4CL.js,2119M3Ks9rL.js,61U0GkYf7LL.js_.js?AUIClients/AuthenticationPortalAssets&L3XM6gEo#818867-T2');
  ...
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/41JjQS045ZL.js?AUIClients/CVFAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/8150jbgvn9L.js?AUIClients/SiegeClientSideEncryptionAUI');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/31jdfgcsPAL.js?AUIClients/AmazonUIFormControlsJS');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/71uDWEj57RL.js?AUIClients/IdentityWebAuthnAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/51lT2t4s7KL.js?AUIClients/IdentityJsCommonAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/81dH9+J7usL.js?AUIClients/FWCIMAssets');
  (window.AmazonUIPageJS ? AmazonUIPageJS : P).load.js('https://images-na.ssl-images-amazon.com/images/I/A1M0w62OGNL.js?AUIClients/ACICAssets');
</script>
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 3172)</script></head>
  ...
  <body class="ap-locale-en_US a-m-us a-aui_72554-c a-aui_a11y_6_837773-c a-aui_killswitch_csa_logger_372963-t1 a-aui_pci_risk_banner_210084-c a-aui_template_weblab_cache_333406-c a-aui_tnr_v2_180836-c a-bw_aui_cxc_alert_measurement_1074111-c">
...
if (window.csa) {
    csa("Config", {
        ...
        'CacheDetection.RequestID': "ABPPNKHERF2539EJGPPZ",
    ...
    csa("Events")("setEntity", {
        page: {requestId: "ABPPNKHERF2539EJGPPZ", meaningful: "interactive"},
        session: {id: "137-9116637-5138647"}
    });
}
...
<script>window.ue && ue.count && ue.count('CSMLibrarySize', 18538)</script><div id="a-page"><script type="a-state" data-a-state="{&quot;key&quot;:&quot;a-wlab-states&quot;}">{"AUI_KILLSWITCH_CSA_LOGGER_372963":"T1"}</script>
...
<div class="a-section a-spacing-medium a-text-center">
          ...
          <a class="a-link-nav-icon" href="/">
            <img src="https://m.media-amazon.com/images/G/01/rainier/nav/sc-unified._CB420062852_.png"/>
          </a>
...
<div id="passkey-error-alert" class="a-box a-alert a-alert-error aok-hidden a-spacing-base" role="alert"><div class="a-box-inner a-alert-container"><h4 class="a-alert-heading">Passkey error</h4><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
...
<a id="ap_switch_account_link" class="a-link-normal" href="https://sellercentral.amazon.com/ap/signin?ie=UTF8&amp;openid.pape.max_auth_age=0&amp;openid.return_to=https%3A%2F%2Fsellercentral.amazon.com%2Faccount-switcher%2Fdropdown-assets-loader.js&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.assoc_handle=sc_na_amazon_v2&amp;openid.mode=checkid_setup&amp;language=en_US&amp;pageId=sc_amazon_v3_unified&amp;ignoreAuthState=1&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;switch_account=picker&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0&amp;fromAuthPrompt=1">
  Switch accounts
</a>
        </div>
      </div>
...
<div class="a-section auth-prompt-section">
  <div class="a-row" style="height:60px;">
    ...
    <div class="a-fixed-right-grid-col auth-prompt-spacing-top-micro" style="float:left;">
        ...
        <img alt="" src="https://www.amazon.com/avatar/default?customer_id=A2C740A2HUYZPY&amp;max_width=50&amp;max_height=50&amp;square=true" class="auth-circular-image"/>
    ...
    <div class="a-fixed-right-grid-col auth-prompt-profile-details a-col-right" style="width:230px;margin-right:-230px;float:left;">
      <div class="a-row a-grid-vertical-align a-grid-center" style="height:60px;">
        <div class="a-column a-span12 a-text-left">
          ...
          <div class="a-row a-size-base a-color-tertiary auth-text-truncate">
            leo@slopepay.com
          </div>
        </div>
      </div>
  ...
  <input type="hidden" name="email" value="leo@slopepay.com" id="ap-claim"/>
  
  <input type="text" value="leo@slopepay.com" id="ap-credential-autofill-hint" autocomplete="email" name="claim-autofill-hint" class="a-input-text hide" data-claim="leo@slopepay.com"/>
</div>


      

      <form name="signIn" method="post" novalidate action="https://sellercentral.amazon.com/ap/signin" class="a-spacing-none">
        
          
          
            <input type="hidden" name="appActionToken" value="lObfkQM4l2zsBlggiiBZ1RrJmHAj3D" /><input type="hidden" name="appAction" value="SIGNIN" />
    ...
    <input type="hidden" name="openid.return_to" value="ape:aHR0cHM6Ly9zZWxsZXJjZW50cmFsLmFtYXpvbi5jb20vYWNjb3VudC1zd2l0Y2hlci9kcm9wZG93bi1hc3NldHMtbG9hZGVyLmpz" />
  
    <input type="hidden" name="prevRID" value="ape:QUJQUE5LSEVSRjI1MzlFSkdQUFo=" />
  
    <input type="hidden" name="workflowState" value="eyJ6aXAiOiJERUYiLCJlbmMiOiJBMjU2R0NNIiwiYWxnIjoiQTI1NktXIn0.9W1FZmPd22I1lZSTUSTNDC2QcQEqBfMcfor6h1SjEDVQnQRyq0vVjg.tOrExA1K4HDJ3jZK.1MvJ2LddMUS-80oR8Sej92csT6-90q9SVDD41mX-OEtg8-39_cWAUAc4S7n71435Zf3TqWv7qRARdKm1GKiPb4gTK49cgbh-n3McSWi114AReqcHv_TpXNa75ezLMKdz1bydmLhb6JlbDB0r95vuQKtUyRymhhXwC_aaZp4qUkNmBuhG9dwIHssMFS0ogwzeZaB-nGqtlI1rf6bqdLDVyXMzqdBYx43lpdtgIxXz8EpRDLQCCghzmCezAy_KxN3Vjjp4nmTH5YcAFpRrdS7GJh-ITx1Ws4PX38p3as4hNT_TUy0Je-6jdzRLY0xefDVPIiJAOSPs0QfwIowocVQ2shPgNqYdRmk_zA1To7n66VWgX5M12rzoptm_fTs07jZnXnkRpGWYTgjvPNKSMjblUCbeWOpsvQVMFMJM6rNiWc2bCCJ1X6t4303E4necnIeIshbqEGmJnuEKw8durVhuwWhWqMllzfI9S5Ga-6ps0AE8HZ30hJL388O5AOVraplbLAw65uxvMgRqERnRI-5P2Sb_ALQdGaBvx6qFVHZrpa73yKspqB2PTRgfLzLT0gNsmmjHHm-HGFu3zGAdbpT-oTqDGCJbOt81sm9qIr-GLtH_MVbXPjBplEI00Ctaie9PxWO2U1ADUkdc5dtE7qv-7JxEyQBpZaSpdJQ1OdjEPbdi7f7OSRIihyP_B6vpu6qmB6ms_utffv0KmODl9HflgCbhYLEJ9GZtSjQvMsnMFwyEcHsomRb4MctRPNMmrJxyx-Jiy3C3YOUV2HIBQVFlnQzApbNBy5Pi99hnQNmZHSP0JCt9qp5PlwkY5mHoKTVC_eVMMQixhlxZAICBXec4Wabfcu0K2Ky8flYVVYBgM67DQNyr7gPN7Q5PhFXWcbo9lg59lQDTsAApvc7i8AUjXyvXT2V7N1hGLQgjDp_RtzPpsZ8_cw08z6eZMGcrJ6EPO4fceXWwhKVIEzSs4AtClyGGY3fLiFeXwdaKe4CZg_pOlXw3Tvf_iW-Hyg-ErOYbIbtzYKPz6q3jjnbthyMQ6RSWuHZzKRS3BxWlo0jv0DrERNxyq7C0KvDGKDWdK4TWrwyTV8N3zo-C411OmWCPSNsy.3GcptPhizvhS6CPatBd9Sg" />
...
<a id="auth-fpp-link-bottom" class="a-link-normal" href="https://sellercentral.amazon.com/ap/forgotpassword?showRememberMe=true&amp;openid.pape.max_auth_age=0&amp;openid.identity=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;language=en_US&amp;pageId=sc_amazon_v3_unified&amp;openid.return_to=https%3A%2F%2Fsellercentral.amazon.com%2Faccount-switcher%2Fdropdown-assets-loader.js&amp;prevRID=ABPPNKHERF2539EJGPPZ&amp;openid.assoc_handle=sc_na_amazon_v2&amp;openid.mode=checkid_setup&amp;prepopulatedLoginId=&amp;failedSignInCount=0&amp;openid.claimed_id=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0%2Fidentifier_select&amp;openid.ns=http%3A%2F%2Fspecs.openid.net%2Fauth%2F2.0">
  Forgot password?
</a>
      </div>
  ...
  <input type="password" maxlength="1024" id="ap_password" autocomplete="current-password" name="password" class="a-input-text a-span12 auth-autofocus auth-required-field" aria-required="true"/>
...
<div id="auth-password-missing-alert" class="a-box a-alert-inline a-alert-inline-error auth-inlined-error-message a-spacing-top-base" role="alert"><div class="a-box-inner a-alert-container"><i class="a-icon a-icon-alert"></i><div class="a-alert-content">
  Enter your password
</div></div></div>
          ...
          <div class="a-section a-spacing-top-extra-large">
            ...
            <span id="auth-signin-button" class="a-button a-button-span12 a-button-primary auth-disable-button-on-submit"><span class="a-button-inner"><input id="signInSubmit" tabindex="4" class="a-button-input" type="submit" aria-labelledby="auth-signin-button-announce"/><span id="auth-signin-button-announce" class="a-button-text" aria-hidden="true">
              Sign in
            </span></span></span>
...
<script type="text/javascript">cf()</script>
  ...
  <!-- defining variable value for the keep me sign in checkbox  -->
  

  <!-- defining variable value for the details pop-over  -->
  ...
  <div class="a-row a-spacing-top-medium">
    <div class="a-section a-text-left">
      <label for="auth-remember-me" class="a-form-label">
            ...
            <input type="hidden" name="kmsiWeblabTreatment" value="C" id="kmsi-weblab-treatment"/>
        
        <div data-a-input-name="rememberMe" class="a-checkbox"><label><input type="checkbox" name="rememberMe" value="true" aria-label="Keep me signed in."/><i class="a-icon a-icon-checkbox"></i><span class="a-label a-checkbox-label">
          Keep me signed in.
          <span class="a-declarative" data-action="a-popover" data-a-popover="{&quot;closeButtonLabel&quot;:&quot;&quot;,&quot;activate&quot;:&quot;onclick&quot;,&quot;header&quot;:&quot;\&quot;Keep Me Signed In\&quot; Checkbox&quot;,&quot;inlineContent&quot;:&quot;\u003cp&gt;Choosing \&quot;Keep me signed in\&quot; reduces the number of times you're asked to Sign-In on this device.\u003c\/p&gt;\n\u003cp&gt;To keep your account secure, use this option only on your personal devices.\u003c\/p&gt;&quot;}">
            <a id="remember_me_learn_more_link" aria-label="Details about Keep Me Signed In" href="javascript:void(0)" role="button" class="a-popover-trigger a-declarative">
               Details
            ...
            <div class="a-row">
              <span id="auth-signin-cancel-link" class="a-button a-spacing-base a-spacing-top-base a-button-span12 a-button-base"><span class="a-button-inner"><a id="signInCancelSubmit" tabindex="6" href="/?apCustomerCancelled=true" class="a-button-text">
                Cancel
              </a></span></span>
            </div>
...
P.when('auth-validate-form-handler', "acic-component", "ready").execute('acic-setup', function(AuthValidateFormHandler) {
    ...
    if (aautTargetForm) {
        setAAToken("137-9116637-5138647-" + Date.now(), aautTargetForm);
...
function getClientContext(aautTargetForm) {
    ...
    context.sessionId = "137-9116637-5138647";
    context.marketplaceId = "ATVPDKIKX0DER";
    context.rid = "ABPPNKHERF2539EJGPPZ";
    context.ubid = "131-0804435-3142958";
...
var ue_spty = "AuthPromptActSwitcher";
...
if (window.csa) {
    csa("Events")("setEntity", {
        page:{pageType: "AuthenticationPortal", subPageType: "AuthPromptActSwitcher", pageTypeId: ""}
    });
}
...
<noscript>
    <img height="1" width="1" style='display:none;visibility:hidden;' src='//fls-na.amazon.com/1/batch/1/OP/ATVPDKIKX0DER:137-9116637-5138647:ABPPNKHERF2539EJGPPZ$uedata=s:%2Fap%2Fuedata%3Fnoscript%26id%3DABPPNKHERF2539EJGPPZ:0' alt=""/>
</noscript>

<script>window.ue && ue.count && ue.count('CSMLibrarySize', 49429)</script></body>
</html>
