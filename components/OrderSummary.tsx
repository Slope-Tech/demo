import {
  Divider, Grid, Group, List, Text, Title,
} from '@mantine/core';
  ...
  return (
    <>
          ...
          <List.Item key={productItem.id} mb="md">
            <Grid>
              ...
              <Grid.Col span={9}>
                ...
                <Text size="sm" fw={700}>
                  <Text span color="dimmed">Price:</Text>
                  {' '}
                  {formatCurrency(productItem.price)}
                </Text>
                <Text size="sm" fw={700}>
                  <Text span color="dimmed">Quantity:</Text>
                  {' '}
      ...
      <Group position="apart" mb={5}>
        <Text color="dimmed" size="sm" fw={700}>Subtotal</Text>
        <Text size="sm" fw={700}>{formatCurrency(totals.subtotal)}</Text>
      </Group>
      <Group position="apart" mb={5}>
        <Text color="dimmed" size="sm" fw={700}>Taxes</Text>
        <Text size="sm" fw={700}>{formatCurrency(totals.taxes)}</Text>
      </Group>
      <Divider my="sm" variant="dotted" />
      <Group position="apart" mb={5}>
        <Text color="dimmed" size="sm" fw={700}>Total</Text>
